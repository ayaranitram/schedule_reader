...
def extract_welspecs(schedule_dict:dict) -> pd.DataFrame:
    ...
    Return:
        pandas.DataFrame
    """
    welspecs_columns = ['date', 'well', 'group', 'I', 'J', 'reference depth', 'preferred phase', 'drainage radius',
...
def extract_welspecl(schedule_dict:dict) -> pd.DataFrame:
    """
    ...
    Return:
        pandas.DataFrame
    """
    welspecl_columns = ['date', 'well', 'group', 'local grid', 'I', 'J', 'reference depth', 'preferred phase',
...
def extract_wellspec(schedule_dict:dict) -> pd.DataFrame:
    """
...
def extract_welspec2(schedule_dict:dict) -> pd.DataFrame:
    """
